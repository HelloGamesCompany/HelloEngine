...
#include "Ak/samples/AkFilePackage.h"
...
public:
	...
	// By default, when a file is not found in a package, it will fall back on T_LLIOHOOK_FILELOC
...
#include "Ak/samples/AkFilePackageLowLevelIO.inl"
