...
void BarrierSpawner::Start()
{
    ...
    if (enemyMeleeSpawner1Ref == nullptr) Console::Log("EnemyMeleeSpawner missing in BarrierSpawner Script.");
    enemyMeleeSpawner2Ref = (EnemyMeleeSpawner*)spawner2.GetScript("EnemyMeleeSpawner");
    if (enemyMeleeSpawner2Ref == nullptr) Console::Log("EnemyMeleeSpawner missing in BarrierSpawner Script.");
...
{
    if (!enemyMeleeSpawner1Ref || !enemyMeleeSpawner2Ref) return;
